...
Elm.WordCount = Elm.WordCount || {};
Elm.WordCount.make = function (_elm) {
   "use strict";
   _elm.WordCount = _elm.WordCount || {};
   if (_elm.WordCount.values) return _elm.WordCount.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var incrementEntry = function (number) {
      var _p0 = number;
      if (_p0.ctor === "Nothing") {
            return $Maybe.Nothing;
         } else {
            return $Maybe.Just(_p0._0 + 1);
         }
   };
   var isGoodChar = function (test_c) {    var goodCharRegex = $Regex.regex("[a-z]|[0-9]");return A2($Regex.contains,goodCharRegex,$String.fromChar(test_c));};
   var wCount = F3(function (phrase,nextWord,outDict) {
      wCount: while (true) {
         var phraseTuple = $String.uncons($String.toLower(phrase));
         var _p1 = phraseTuple;
         if (_p1.ctor === "Nothing") {
               return _U.eq(nextWord,"") ? outDict : A2($Dict.member,nextWord,outDict) ? A3($Dict.update,nextWord,incrementEntry,outDict) : A3($Dict.insert,
               nextWord,
               1,
               outDict);
            } else {
               var _p5 = _p1._0._1;
               var _p4 = _p1._0._0;
               var _p2 = isGoodChar(_p4);
               if (_p2 === true) {
                     var nextWord = A2($String.append,nextWord,$String.fromChar(_p4));
                     var _v3 = _p5,_v4 = nextWord,_v5 = outDict;
                     phrase = _v3;
                     nextWord = _v4;
                     outDict = _v5;
                     continue wCount;
                  } else {
                     var isEmptyWord = _U.eq(nextWord,"");
                     var _p3 = isEmptyWord;
                     if (_p3 === true) {
                           var _v7 = _p5,_v8 = "",_v9 = outDict;
                           phrase = _v7;
                           nextWord = _v8;
                           outDict = _v9;
                           continue wCount;
                        } else {
                           if (A2($Dict.member,nextWord,outDict)) {
                                 var _v10 = _p5,_v11 = "",_v12 = A3($Dict.update,nextWord,incrementEntry,outDict);
                                 phrase = _v10;
                                 nextWord = _v11;
                                 outDict = _v12;
                                 continue wCount;
                              } else {
                                 var _v13 = _p5,_v14 = "",_v15 = A3($Dict.insert,nextWord,1,outDict);
                                 phrase = _v13;
                                 nextWord = _v14;
                                 outDict = _v15;
                                 continue wCount;
   ...
   var wordCount = function (phrase) {    return A3(wCount,phrase,"",$Dict.empty);};
   return _elm.WordCount.values = {_op: _op,wordCount: wordCount,wCount: wCount,isGoodChar: isGoodChar,incrementEntry: incrementEntry};
};
