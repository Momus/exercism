...
Elm.Anagram.make = function (_elm) {
   ...
   var _op = {};
   var incrementEntry = function (charecter) {
      var _p0 = charecter;
      if (_p0.ctor === "Nothing") {
            return $Maybe.Nothing;
         } else {
   ...
   var isAnagram = F2(function (wordOne,wordTwo) {    return _U.eq(wordOne,wordTwo) ? true : false;});
   var detect = F2(function (word,wordList) {    return A2($List.filter,isAnagram(word),wordList);});
   return _elm.Anagram.values = {_op: _op,detect: detect,isAnagram: isAnagram,incrementEntry: incrementEntry};
};
