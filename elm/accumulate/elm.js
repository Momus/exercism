...
Elm.Accumulate.make = function (_elm) {
   ...
   var accumulate = F2(function (inFunction,listIn) {    return A3(my_map,inFunction,listIn,_U.list([]));});
   return _elm.Accumulate.values = {_op: _op,accumulate: accumulate,my_map: my_map};
};
