...
Elm.DifferenceOfSquares.make = function (_elm) {
   ...
   var sumOfSquares = function (n) {    return $List.sum(A2($List.map,square,_U.range(1,n)));};
   var squareOfSum = function (n) {    return square($List.sum(_U.range(1,n)));};
   var difference = function (n) {    return squareOfSum(n) - sumOfSquares(n);};
   return _elm.DifferenceOfSquares.values = {_op: _op,squareOfSum: squareOfSum,sumOfSquares: sumOfSquares,difference: difference,square: square};
};
