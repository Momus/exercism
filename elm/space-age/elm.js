...
Elm.SpaceAge.make = function (_elm) {
   ...
   var _op = {};
   var orbitEarthFraction = {earth: 1.0
                            ,mercury: 0.2408467
                            ,venus: 0.61519726
                            ,mars: 1.8808158
                            ,jupiter: 11.862615
                            ...
                            ,uranus: 84.016846
                            ,neptune: 164.79132};
   var earthOrbitSec = 3.15576e7;
   var ageOn = F2(function (planet,ageSec) {
      var _p0 = planet;
      switch (_p0.ctor)
      {case "Mercury": return ageSec / (orbitEarthFraction.mercury * earthOrbitSec);
         case "Venus": return ageSec / (orbitEarthFraction.venus * earthOrbitSec);
         case "Earth": return ageSec / (orbitEarthFraction.earth * earthOrbitSec);
         case "Mars": return ageSec / (orbitEarthFraction.mars * earthOrbitSec);
         case "Jupiter": return ageSec / (orbitEarthFraction.jupiter * earthOrbitSec);
         case "Saturn": return ageSec / (orbitEarthFraction.saturn * earthOrbitSec);
         case "Uranus": return ageSec / (orbitEarthFraction.uranus * earthOrbitSec);
         default: return ageSec / (orbitEarthFraction.neptune * earthOrbitSec);}
   });
   ...
   return _elm.SpaceAge.values = {_op: _op
                                 ...
                                 ,Neptune: Neptune
                                 ,ageOn: ageOn
                                 ,earthOrbitSec: earthOrbitSec
                                 ,orbitEarthFraction: orbitEarthFraction};
};
