...
Elm.RNATranscription.make = function (_elm) {
   "use strict";
   _elm.RNATranscription = _elm.RNATranscription || {};
   if (_elm.RNATranscription.values) return _elm.RNATranscription.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var dnaCompDict = $Dict.fromList(_U.list([{ctor: "_Tuple2",_0: _U.chr("G"),_1: _U.chr("C")}
                                            ,{ctor: "_Tuple2",_0: _U.chr("C"),_1: _U.chr("G")}
                                            ,{ctor: "_Tuple2",_0: _U.chr("T"),_1: _U.chr("A")}
                                            ,{ctor: "_Tuple2",_0: _U.chr("A"),_1: _U.chr("U")}]));
   var getComplement = F3(function (strand,nucleotideDict,outStrand) {
      getComplement: while (true) {
         var _p0 = $String.uncons(strand);
         if (_p0.ctor === "Nothing") {
               return $Result.Ok(outStrand);
            } else {
               var _p2 = _p0._0._0;
               var complement = A2($Dict.get,_p2,nucleotideDict);
               var _p1 = complement;
               if (_p1.ctor === "Nothing") {
                     return $Result.Err(_p2);
                  } else {
                     var _v2 = _p0._0._1,_v3 = nucleotideDict,_v4 = A2($String.append,outStrand,$String.fromChar(_p1._0));
                     strand = _v2;
                     nucleotideDict = _v3;
                     outStrand = _v4;
                     continue getComplement;
                  }
            }
      }
   });
   var toRNA = function (dnaSequence) {    return A3(getComplement,dnaSequence,dnaCompDict,"");};
   return _elm.RNATranscription.values = {_op: _op,toRNA: toRNA,getComplement: getComplement,dnaCompDict: dnaCompDict};
};
